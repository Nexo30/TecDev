...
class Articulos_Model extends Model
{
    ...
    public function get()
    {
        ...
        $item = new Articulo(); //se crea el objeto articulo y se guarda en item
        //se crean los atributos del objeto Articulo
        $item->id = "1";
        $item->codigo = "alt1";
        $item->nombre = "Alternador Chevrolet";
        $item->descripcion = "Alternador Chevrolet Aveo";
        $item->precio = "$5000";
        $item->fecha = "2011";
        ...
        $item->id = "2";
        $item->codigo = "amr1";
        $item->nombre = "Amortiguador delantero Chevrolet";
        $item->descripcion = "Amortiguador Chevrolet Aveo";
        $item->precio = "$3000";
        $item->fecha = "2010";
        //introduce el arreglo item dentro de items
        array_push($items, $item);

        //retorna el arreglo items
        return $items;
