...
//Si se quiere subir una imagen
        ...
        if ($this->model->ingresar_articulo(['cod_art' => $cod_art, 'cod_cat' => $cod_cat, 'nombre' => $nombre, 'marca' => $marca, 'modelo' => $modelo, 'descripcion' => $descripcion, 'precio' => $precio, 'stock' => $precio])) {
